            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="customerForm" method="post" action="{{ route('store.clients') }}" enctype="multipart/form-data">
                        ...
                        @csrf
                        <input type="hidden" name="customerId" id="customerId" value="{{ ($data)?$data->id :'' }}">



                        <div class="form-group">
                            <label for="name">Name*</label>
                            <input type="text" class="form-control my-input" id="name" name="name" value="{{ ($data)?$data->name:'' }}" placeholder="Customer Name" autocomplete="off" required>
                        </div>
