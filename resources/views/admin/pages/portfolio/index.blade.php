        ...
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">
                    ...
                    <a href="{{ route('portfolios.index') }}" class="btn btn-primary">View Portfolios</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="reviewForm" method="post" action="{{ route('portfolios.store') }}" enctype="multipart/form-data">
                        ...
                        @csrf
                        <input type="hidden" name="PortfolioId" id="PortfolioId" value="{{ ($data)?$data->id :'' }}">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control my-input" id="short_title" name="short_title" value="{{ ($data)?$data->short_title:'' }}" placeholder="Short title" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control my-input selectbox" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="short_description" id="short_description" class="form-control my-input" cols="30" rows="2" placeholder="Short description">{{ ($data)?$data->short_desc:'' }}</textarea>
                        </div>
                        <div class="form-group">
