 <nav class="sidebar sidebar-offcanvas" id="sidebar">
     <ul class="nav">
         ...
         <li class="nav-item {{ Str::startsWith(Route::currentRouteName(), 'meta.') ? 'active' : '' }} ">
             <a class="nav-link " data-bs-toggle="collapse" href="#ui-meta" aria-expanded="false" aria-controls="ui-meta">
                 <span class="menu-title">Manage Meta-Data</span>
                 <i class="menu-arrow"></i>
                 <i class="mdi mdi-format-list-bulleted menu-icon"></i>
             </a>
             <div class="collapse" id="ui-meta">
                 <ul class="nav flex-column sub-menu">
                     <li class="nav-item"> <a class="nav-link " href="{{ route('meta.index') }}#banner_section">Banner-section</a>
                     <li class="nav-item"> <a class="nav-link " href="{{ route('meta.index') }}#sub_section">Sub-section</a>
                     <li class="nav-item"> <a class="nav-link " href="{{ route('meta.index') }}#query_section">Query-section</a>
                     </li>
